...
class PlaybackNode : public rclcpp::Node
{
  public:
    ...
    adom_interface_ = std::make_unique<ApplicationInterface>("DIRECTORY_01", dir_cfg_path, topic_cfg_path, setup_path);
  ...
  private:
    ...
    void timer_callback()
    {
      while (reader_.has_next()) {
        ...
        adom_interface_->registerNewData(IMAGE, cv_ptr->image.data, false);
