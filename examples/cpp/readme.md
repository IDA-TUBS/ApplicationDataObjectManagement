...
## Download test data
First make sure you download the provided test data (175 camera images and RoI information tracked in a csv-file) and save it in *ApplicationDataObjectManagement/examples/cpp/data*.    
Find the files here: https://cloud.tu-braunschweig.de/s/Fq8dGt22b4iozwZ. 
...
Open two terminals for both of the test applications in *ApplicationDataObjectManagement/build/bin*.
